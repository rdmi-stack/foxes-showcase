...
const products = [
  ...
  { name: "Brand Sites", href: "/voice-demos", color: "from-teal-500 to-emerald-500", icon: "M12 18.75a6.75 6.75 0 0 0 6.75-6.75V7.5a6.75 6.75 0 0 0-13.5 0V12A6.75 6.75 0 0 0 12 18.75Zm0 0v3m-3 0h6" },
